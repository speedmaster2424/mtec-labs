...
case 141 ... 160:
    print ("You are in the Moderate zone. Activity in this zone increase maximum preformance capacity for shorter sessions.")
case 161 ... 180:
    print ("You are in the Hard zone. Activity in this zone helps fit athletes develop speed.")
case 181 ... 200:
    print ("You are in Maximm zone. Activity in this zone helps fit athletes develop speed.")
default:
    print ("Please slow down your heart rate else injury occur.")
}
/*:
